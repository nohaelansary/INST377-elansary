...
// bar chart
	...
	$("#submit").click(
		...
		city_name = document.forms["city_form"]["city_name"].value;
		country_id = document.forms["city_form"]["country_id"].value;
...
<form id="city_form" name="city_form">
	City: 
	<input type="text" name="city_name" value="city">
  <br>
   Country_id:<br>
  <input type="text" name="country_id" value="country id">
  <br><br>
</form>
